      ...
      problems: [
        {
          ...
          answer: "2",
          type: "input" as const,
          hints: ["Subtract 3 from both sides", "Divide both sides by 2"],
        },
        {
          id: 2,
          question: "Which of the following is equivalent to 3(x + 2)?",
          options: ["3x + 2", "3x + 6", "3x + 5", "3 + 2x"],
          answer: "3x + 6",
          type: "mcq" as const,
          hints: ["Use the distributive property"],
        },
      ],
    },
    {
      ...
      problems: [
        {
          ...
          answer: "4",
          type: "input" as const,
          hints: ["Add the two equations", "Divide by 2"],
        },
        {
          id: 4,
          question:
      ...
      problems: [
        {
          ...
          answer: "4",
          type: "mcq" as const,
          hints: ["The y-intercept is where x = 0"],
        },
        {
          id: 6,
          question:
          ...
          answer: "2",
          type: "input" as const,
          hints: ["Use the slope formula: (y₂ - y₁)/(x₂ - x₁)"],
        },
      ],
    },
    {
      ...
      problems: [
        {
          ...
          hints: [
            ...
            "Look for factors of 6 that add up to -5",
          ],
        },
        {
          id: 8,
          ...
          answer: "0",
          type: "mcq" as const,
          hints: ["The discriminant is b² - 4ac", "a = 1, b = -6, c = 9"],
        },
      ],
    },
    {
      ...
      problems: [
        {
          id: 9,
          question:
            "Which of the following is the factored form of x² + 7x + 12?",
          options: [
            "(x + 3)(x + 4)",
            "(x + 6)(x + 2)",
            "(x + 3)(x - 4)",
          ...
          answer: "(x + 3)(x + 4)",
          type: "mcq" as const,
          hints: ["Look for factors of 12 that add up to 7"],
        },
        {
          id: 10,
          ...
          answer: "(x+4)(x-4)",
          type: "input" as const,
          hints: ["This is a difference of squares", "a² - b² = (a+b)(a-b)"],
        },
      ],
    },
  ];
