  ...
  return [
    {
      ...
      description: 'Practice test for SSC CGL exam with 25 questions on Mathematics',
      category: 'SSC',
      subject: 'Mathematics',
    ...
    },
    {
      ...
      description: 'Practice test for Railways RRB exam with 10 questions on Mathematics',
      category: 'Railways',
      subject: 'Mathematics',
      difficulty: 'intermediate',
    ...
    },
    {
      ...
      description: 'Practice test for Banking SBI PO exam with 10 questions on Mathematics',
      category: 'Banking',
      subject: 'Mathematics',
      difficulty: 'advanced',
    ...
    },
    {
      ...
      description: 'Practice test for ADRE exam with 10 questions on Mathematics',
      category: 'ADRE',
      subject: 'Mathematics',
      difficulty: 'advanced',
...
export function filterMockTests(
  ...
  return mockTests.filter(test => {
    const categoryMatch = !category || category === 'all' || test.category.toLowerCase() === category.toLowerCase()
    const subjectMatch = !subject || subject === 'all' || test.subject.toLowerCase() === subject.toLowerCase()
    const difficultyMatch = !difficulty || difficulty === 'all' || test.difficulty.toLowerCase() === difficulty.toLowerCase()
